...
export const coachingPackages: CoachingPackage[] = [
  ...
  },
  {
    ...
    compactMeta:
      "Lộ trình cá nhân hóa · Thiết kế riêng theo mục tiêu đồng hành · Có công cụ và tài liệu đi kèm",
    detailAudienceTitle: "Dành cho ai?",
    fitItems: [
    ...
    includedItems: [
      "Lộ trình Coaching được thiết kế riêng theo mục tiêu đồng hành",
      "Cá nhân hóa theo bối cảnh, nhu cầu, thời lượng và phạm vi hỗ trợ thực tế",
      "Kết hợp Coaching, Bản đồ Thấu hiểu Con người và các công cụ phù hợp",
      "Có tài liệu, bài tập hoặc công cụ thực hành đi kèm theo từng giai đoạn nếu cần",
      "Đồng hành linh hoạt theo tiến trình chuyển hóa của khách hàng",
  ...
  },
  {
    ...
    compactMeta: "01 phiên Coaching · Tập trung vào một vấn đề cụ thể",
    detailAudienceTitle: "Phù hợp với ai?",
    fitItems: [
      "Khách hàng đã từng Coaching cùng Mr. Thấu Hiểu",
      "Khách hàng đã có Bản đồ cá nhân và muốn được soi chiếu sâu hơn",
      "Người cần thêm một phiên riêng lẻ để làm rõ vấn đề cụ thể",
      "Người muốn được soi chiếu lại trước một quyết định quan trọng",
    ],
    includedTitle: "Bạn nhận được gì?",
    includedItems: [
      "01 phiên Coaching riêng lẻ",
      "Tập trung vào một vấn đề hoặc mục tiêu cụ thể",
      "Gợi ý hướng xử lý và bước hành động tiếp theo",
      "Có thể đăng ký online hoặc offline tùy nhu cầu",
    ],
    expectedResultTitle: "Kết quả mong đợi",
    expectedResult: "",
